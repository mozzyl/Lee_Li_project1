...
# Plot
plot(ozone$ozone, x=ozone$temperature, type="l", main="Loess Smoothing and Prediction", xlab="Temperature", ylab="Ozone (Median)")
...
# Plot
plot(mcycle$accel, x=mcycle$times, type="l", main="Loess Smoothing and Prediction", xlab="Times", ylab="Accel (Median)")
